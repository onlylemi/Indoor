...
import com.onlylemi.utils.ABViewUtil;
...
//        Logger.d(TAG, "scrollview: " + scrollView);
        Log.i(TAG, "parent: " + this.getParent());
...
//                    Logger.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        int padding = Assist.dip2px(context, 15);
...
//            position = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setStrokeWidth(Assist.dip2px(context, 1f));
        }
